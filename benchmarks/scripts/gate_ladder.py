...
LADDER: dict[str, dict] = {
    ...
    "gen11":       {"kind": "net", "net": str(REPO / "target-cvs/gen11-lich.json"),
                    "what": "gen11 eval: 6M Lichess d16 search labels, warm-started, sigmoid-mid target, no calibration needed"},
    "pinmovegen":  {"kind": "flag", "add": ["--pinmovegen"],
                    "what": "pin-aware legal movegen: compute pinned+checkers once, only verify king/pinned/ep moves"},
    "pawnhist":    {"kind": "flag", "add": ["--pawnhist"],
                    "what": "pawn-structure-keyed quiet history (SF pawn_entry) with gravity bonus+malus"},
    "pawnhist-ch2": {"kind": "flag", "add": ["--pawnhist", "--conthist2"],
                    "what": "pawn history + second continuation history (combined ordering)"},
