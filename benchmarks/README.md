...
| 3 cp-loss | `bench_cploss.py` | suites dev/fresh/hard-100, SF-d12 child scoring. avgCP/median/p90/p95/bl100/**bl200 (must not increase)**/danger (must not regress). Exact-match alone is NOT enough — gen7's win was calibration, not match% |
