...
//!
//! Weights load exactly like `analyze`: --base w.json --rung2 r.json --net net.json
...
use cvs_bitboard_core::eval::{Rung2Weights, ValueNet, ValueWeights};
...
fn main() {
    ...
    for line in stdin.lock().lines() {
        ...
        match tok.next() {
            ...
            Some("ucinewgame") => {
                searcher = Searcher::new_with_net(base, rung2.clone(), net.clone());
