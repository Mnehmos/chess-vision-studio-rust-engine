...
fn facts_for(pos: &Position, include_motifs: bool) -> PositionFacts {
    ...
    if include_motifs {
        ...
        facts.available_defensive_interposition = defensive_interposition_opportunities(pos);
        ...
        facts.opponent_available_defensive_interposition =
            defensive_interposition_opportunities_for(pos, pos.stm.flip());
...
pub fn build_teaching_fact_bundle(
    ...
    if include_motifs {
        ...
        validators.push("defensive_interposition_validation".to_string());
    }
