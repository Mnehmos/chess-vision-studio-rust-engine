...
use crate::facts::motifs::{
    ...
    motif_opportunities_for, pin_opportunities, pin_opportunities_for, remove_guard_opportunities,
    remove_guard_opportunities_for, skewer_opportunities, skewer_opportunities_for,
};
