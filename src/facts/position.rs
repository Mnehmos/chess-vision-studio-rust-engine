...
pub fn position_facts(pos: &Position) -> PositionFacts {
    PositionFacts {
        ...
        available_discovered_defense: FactCollection::uncomputed("not_requested"),
        available_remove_guard: FactCollection::uncomputed("not_requested"),
        available_trapped: FactCollection::uncomputed("not_requested"),
        available_desperado: FactCollection::uncomputed("not_requested"),
        ...
        available_attack_defender: FactCollection::uncomputed("not_requested"),
        available_deflection: FactCollection::uncomputed("not_requested"),
        available_lure_defender: FactCollection::uncomputed("not_requested"),
        available_interference: FactCollection::uncomputed("not_requested"),
        ...
        available_defensive_interposition: FactCollection::uncomputed("not_requested"),
        ...
        opponent_available_discovered_defense: FactCollection::uncomputed("not_requested"),
        ...
        opponent_available_desperado: FactCollection::uncomputed("not_requested"),
        ...
        opponent_available_attack_defender: FactCollection::uncomputed("not_requested"),
        opponent_available_deflection: FactCollection::uncomputed("not_requested"),
        opponent_available_lure_defender: FactCollection::uncomputed("not_requested"),
        opponent_available_interference: FactCollection::uncomputed("not_requested"),
        ...
        opponent_available_defensive_interposition: FactCollection::uncomputed("not_requested"),
